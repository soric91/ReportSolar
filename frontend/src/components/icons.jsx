...
export function RefreshIcon({ className = base }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h5M20 20v-5h-5M4.5 9a7.5 7.5 0 0113-3.5L20 9M19.5 15a7.5 7.5 0 01-13 3.5L4 15" />
    </svg>
  )
}
...
export function CameraIcon({ className = base }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 8a2 2 0 012-2h1.5l1-2h7l1 2H18a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V8z" />
      <circle cx="12" cy="13" r="3.5" />
    </svg>
  )
}

export function GalleryIcon({ className = base }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
      <rect x="3" y="5" width="18" height="14" rx="2" />
      <circle cx="8.5" cy="10" r="1.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M21 16l-5-5-4.5 4.5L9 13l-6 6" />
    </svg>
  )
}
...
export function SaveIcon({ className = base }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
...
export function WifiOffIcon({ className = base }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2 2l20 20M8.5 16.5a5 5 0 017 0M5 12.5a10 10 0 013.5-2.3M19 12.5a10 10 0 00-2.7-1.9M12 20h.01" />
    </svg>
  )
}

export function SpinnerIcon({ className = base }) {
  return (
